...
import org.jboss.as.quickstarts.contacts.test.page.LoginPage;
import org.jboss.as.quickstarts.contacts.test.page.RegisterPage;
import org.jboss.as.quickstarts.contacts.test.page.RoleAssignmentPage;
...
public class ContactsMobilePicketlinkSecuredTest {
    ...
    /**
     * Locator for register page
     */
    @FindByJQuery("[data-role='page']:visible")
    RegisterPage registerPage;

    /**
     * Locator for role assignment page
     */
    @FindByJQuery("[data-role='page']:visible")
    RoleAssignmentPage roleAssignmentPage;
    ...
    public void roleAssignmentTest() {
        ...
        loginPage.signIn("john", "john");
        listPage.waitForPage();
        assertFalse(navigation.isRoleAssignmentAccessible());
        navigation.logout();

        loginPage.signIn("admin", "admin");
        listPage.waitForPage();
        navigation.openRoleAssignmentPage();
        roleAssignmentPage.setRole("john", "ADMIN");
        listPage.waitForPage();
        navigation.logout();

        loginPage.signIn("john", "john");
        listPage.waitForPage();
        assertTrue(navigation.isRoleAssignmentAccessible());
        navigation.logout();
    }
    ...
    public void registrationTest() {
        ...
        registerPage.register("John", "Doe", "john", "password", true);
        assertFalse(registerPage.isUsernameValid());

        registerPage.register("John", "Doe", "jdoe", "password", true);

        assertFalse(loginPage.signIn("jdoe", "wrongpassword"));

        assertTrue(loginPage.signIn("jdoe", "password"));
    }
