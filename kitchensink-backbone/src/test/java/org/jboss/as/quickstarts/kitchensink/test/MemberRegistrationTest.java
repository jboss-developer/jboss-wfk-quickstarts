...
import org.jboss.as.quickstarts.kitchensink.rest.MemberService;
...
public class MemberRegistrationTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap
                ...
                .addClasses(Member.class, MemberService.class,
                        MemberRepository.class, MemberRegistration.class,
                        Resources.class)
    ...
    public void testInvalidRegister() throws Exception {
        ...
        log.info("Invalid member register attempt failed with return code "
                + response.getStatus());
    }
    ...
    public void testDuplicateEmail() throws Exception {
        ...
        Member anotherMember = createMemberInstance("John Doe",
                "jane@mailinator.com", "2133551234");
        ...
        assertEquals(
                ...
                ((Map<String, String>) response.getEntity()).size());
        log.info("Duplicate member register attempt failed with return code "
                + response.getStatus());
    }
